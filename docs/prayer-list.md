...
prayers. While reading, Select offers **Start again** first and **Jump to section** where
...
**Holy Rosary → Today's Mysteries** previews and selects the set using the watch's local weekday. **All Mysteries** lets you choose any set. Each contains five mystery names:
